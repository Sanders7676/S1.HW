...
def intersection_set(l: list, l_1: list) -> list:
    new_set = set(l).difference(set(l_1))
    return list(new_set)

print(intersection_set([3, 1, 3, 4, 2, 4, 12], [4, 15, 43, 1, 15, 1]))
print(intersection_set([3, 4, 1, 5, 1, 3, 10, 4, 9, 5], [9, 6, 6, 5, 10, 1, 10, 9, 1, 5]))